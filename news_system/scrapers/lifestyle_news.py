#!/usr/bin/env python3
# scrapers/lifestyle_news.py - Fixed lifestyle news scraper
...
class LifestyleNewsScraper(NewsScraperBase):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            category="manual_news_system",  # Keep your original category name
    ...
    def scrape(self, past_hours=None):
        ...
        Returns:
            list: New articles
        """
        self.logger.info(f"Starting lifestyle news scrape (past_hours={past_hours})...")
        
        # Call the parent class scrape method
        articles = super().scrape(past_hours)
        
        self.logger.info(f"Lifestyle news scrape complete, found {len(articles)} new articles")
        return articles
...
if __name__ == "__main__":
    ...
    try:
        ...
        main_logger.error(f"Lifestyle news scraper failed: {e}", exc_info=True)
