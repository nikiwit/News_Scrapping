...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("it_news/logs/it_main.log"),
...
def run_pipeline():
    ...
    logger.info("Starting IT news processing pipeline")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="IT news scraping and Telegram posting system")
